...
namespace Raytracer
{
    public struct Matrix : IEquatable<Matrix>
    {
            ...
            ref Vector3 cameraUpVector, Vector3? cameraForwardVector, out Matrix result)
        {
            ...
            {
                vector = Vector3.Multiply(vector, (double)(1f / ((double)Math.Sqrt((double)num))));
            }
            ...
            ref Vector3 rotateAxis, Vector3? cameraForwardVector, Vector3? objectForwardVector, out Matrix result)
        {
            ...
            {
                vector2 = Vector3.Multiply(vector2, (double)(1f / ((double)Math.Sqrt((double)num2))));
            }
        ...
        public static void FindDeterminants(ref Matrix matrix, out double major,
